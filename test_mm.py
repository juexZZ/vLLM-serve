...
plot_bounding_boxes(image, model_response, save_path="./test_visualizations_8B_py28triton34/dining_table_bbox.png")
...
image.thumbnail([640,640], Image.Resampling.LANCZOS)
plot_points_json(image, model_response, save_path="./test_visualizations_8B_py28triton34/football_field_points.png")