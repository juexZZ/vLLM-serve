...
def plot_bounding_boxes(im, bounding_boxes, save_path=None):
    """
    ...
    Args:
        ...
        save_path: Optional path to save the visualization. If provided, saves to file instead of showing.
    """
...
def plot_points_json(im, text, save_path=None):
  img = im
  width, height = img.size
  draw = ImageDraw.Draw(img)
  colors = [
